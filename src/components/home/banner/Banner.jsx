...
//   return (
//     <div className="">
//       <div className="md:flex items-center px-8 gap-6">
//         <div>
//           <img
...
// <div className="absolute inset-0 bg-[url('http://res.cloudinary.com/du0uabbwo/image/upload/v1738003737/nre3se0ijh3xdladzd4r.png')]  bg-center h-60"></div>
...
const Banner = () => {
  return (
    <div className="relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[100px] md:h-[200px] bg-[url('http://res.cloudinary.com/du0uabbwo/image/upload/v1738003737/nre3se0ijh3xdladzd4r.png')] bg-cover bg-center"></div>
      {/* <div>
        <div>
          <img
            src="http://res.cloudinary.com/du0uabbwo/image/upload/v1738004464/pzycetfclew2qjhjfnkh.png"
            alt=""
          />
        </div>
      </div> */}
